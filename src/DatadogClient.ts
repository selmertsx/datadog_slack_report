...
export class DatadogClient {
   ...
   */
  public async fetchInfraHosts(from: string, to: string): Promise<DatadogHostMetrics[]> {
   ...
   *
   */
  public async fetchAPMHosts(from: string, to: string): Promise<ProductHostMetricsMap> {
